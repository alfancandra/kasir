	  ...
	  <div id="login-page" style="padding-top:3pc;">
	  	<div class="container">
		      <form class="form-login" method="POST">
		        <h2 class="form-login-heading" style="color:#000" align="center">Aplikasi POS</h2>
		        <div class="container">
		        	<div class="jumbotron">
				        <div class="row" align="center">
						    <div class="col" style="border-right: 1px solid black;">
						    	<a href="index.php" class="btn btn-lg btn-primary">ADMIN</a>
						    </div>
						    <div class="col" style="border-left: 1px solid black;">
						    	<a href="kasir/index.php" class="btn btn-lg btn-primary">KASIR</a>
						    </div>
						</div>
					</div>
				</div>
