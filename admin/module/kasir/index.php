								...
								?>
									<tr>
										...
										<td>
											...
											<a href="index.php?page=kasir/edit&kasir=<?php echo $isi['id_kasir'];?>"><button class="btn btn-warning btn-sm">Edit</button></a>
											<a href="fungsi/hapus/hapus.php?kasir=hapus&id_kasir=<?php echo $isi['id_kasir'];?>" onclick="javascript:return confirm('Hapus Data barang ?');"><button class="btn btn-danger btn-sm">Hapus</button></a></td>
