	 ...
	 */ 
	 class view {
		...
		function __construct($db){
			...
			function jual(){
				$sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, barang.harga_beli, kasir.id_kasir,
			...
			function periode_jual($periode){
				$sql ="SELECT nota.* , barang.id_barang, barang.nama_barang, barang.harga_beli, kasir.id_kasir,
						kasir.nama from nota 
					   left join barang on barang.id_barang=nota.id_barang 
					   left join kasir on kasir.id_kasir=nota.id_kasir WHERE nota.periode = ? 
			...
			function hari_jual($hari){
				...
				$sql ="SELECT nota.* , barang.id_barang, barang.nama_barang,  barang.harga_beli, kasir.id_kasir,
						kasir.nama from nota 
					   left join barang on barang.id_barang=nota.id_barang 
					   left join kasir on kasir.id_kasir=nota.id_kasir WHERE nota.tanggal_input LIKE ? 
					   ORDER BY id_nota ASC";
				$row = $this-> db -> prepare($sql);
